...
function BarNav() {
  ...
  return (
    ...
    <Card className="navColor centrar">
      ...
      <Nav.Item>
        <Nav.Link className="linkColor gap-5 mx-2" href="/NuevoServicio" disabled>Nuevo Servicio</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="linkColor gap-5 mx-2" href="/Servicios" disabled
        >Servicios</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="linkColor gap-5 mx-2" href="/Roles" disabled>Roles</Nav.Link>
      </Nav.Item>
      <Nav.Item >
          <Dropdown>
